...
def main():
    ...
    image=initRaetsel(image,'1', 'Buchstaben-Salat', color = COLORED)
    ...
    # Prints um mit Node-RED zu kommunizieren 
    ...
    if(netzwerk and kiste):
        ...
        image=initRaetsel(image,'1', 'Buchstaben-Salat', color = UNCOLORED)
